...
(test-util:with-test (:name :avx512-evex-instructions)
  (let ((k1 (sb-x86-64-asm::get-fpr :kreg 1))
    ...
    ;; Broadcast - verify VEX encoding on XMM/YMM and EVEX on ZMM
    (test-assemble `(vbroadcastss ,xmm0 ,xmm1)
                   "C4E27918C1       VBROADCASTSS XMM0, XMM1")
    ...
    (test-assemble `(vbroadcastsd ,zmm0 ,xmm1)
                   "62F2FD4819C1     VBROADCASTSD ZMM0, ZMM1")
...
#+x86-64
(test-util:with-test (:name :avx10-converged-vector-instructions)
  (let ((k1 (sb-x86-64-asm::get-fpr :kreg 1))
        (k2 (sb-x86-64-asm::get-fpr :kreg 2))
        (xmm0 (sb-x86-64-asm::get-fpr :xmm 0))
        (xmm1 (sb-x86-64-asm::get-fpr :xmm 1))
        ...
        (xmm31 (sb-x86-64-asm::get-fpr :xmm 31))
        (ymm0 (sb-x86-64-asm::get-fpr :ymm 0))
        (ymm1 (sb-x86-64-asm::get-fpr :ymm 1))
        (ymm2 (sb-x86-64-asm::get-fpr :ymm 2))
        (ymm16 (sb-x86-64-asm::get-fpr :ymm 16))
        (ymm17 (sb-x86-64-asm::get-fpr :ymm 17))
        (ymm18 (sb-x86-64-asm::get-fpr :ymm 18))
        (ymm31 (sb-x86-64-asm::get-fpr :ymm 31))
        (zmm0 (sb-x86-64-asm::get-fpr :zmm 0))
        (zmm1 (sb-x86-64-asm::get-fpr :zmm 1))
        (zmm2 (sb-x86-64-asm::get-fpr :zmm 2))
        (zmm16 (sb-x86-64-asm::get-fpr :zmm 16))
        (zmm17 (sb-x86-64-asm::get-fpr :zmm 17))
        (zmm18 (sb-x86-64-asm::get-fpr :zmm 18)))
    ;; 1. AVX10 128-bit Converged Vector Operations (XMM16..XMM31)
    (test-assemble `(vaddps ,xmm16 ,xmm17 ,xmm18)
                   "62A1740058C2     VADDPS XMM16, XMM17, XMM18")
    (test-assemble `(vaddpd ,xmm16 ,xmm17 ,xmm18)
                   "62A1F50058C2     VADDPD XMM16, XMM17, XMM18")
    (test-assemble `(vaddph ,xmm16 ,xmm17 ,xmm18)
                   "62A5740058C2     VADDPH XMM16, XMM17, XMM18")

    ;; 2. AVX10 256-bit Converged Vector Operations (YMM16..YMM31)
    (test-assemble `(vaddps ,ymm16 ,ymm17 ,ymm18)
                   "62A1742058C2     VADDPS YMM16, YMM17, YMM18")
    (test-assemble `(vaddpd ,ymm16 ,ymm17 ,ymm18)
                   "62A1F52058C2     VADDPD YMM16, YMM17, YMM18")
    (test-assemble `(vaddph ,ymm16 ,ymm17 ,ymm18)
                   "62A5742058C2     VADDPH YMM16, YMM17, YMM18")
    (test-assemble `(vaddph-masked ,ymm16 ,ymm17 ,ymm18 ,k1 :z)
                   "62A574A158C2     VADDPH YMM16, YMM17, YMM18 {K1} {z}")
    (test-assemble `(vsubph ,ymm16 ,ymm17 ,ymm18)
                   "62A574205CC2     VSUBPH YMM16, YMM17, YMM18")
    (test-assemble `(vmulph ,ymm16 ,ymm17 ,ymm18)
                   "62A5742059C2     VMULPH YMM16, YMM17, YMM18")
    (test-assemble `(vdivph ,ymm16 ,ymm17 ,ymm18)
                   "62A574205EC2     VDIVPH YMM16, YMM17, YMM18")
    (test-assemble `(vfmadd132ph ,ymm16 ,ymm17 ,ymm18)
                   "62A6752098C2     VFMADD132PH YMM16, YMM17, YMM18")
    (test-assemble `(vfmadd213ph ,ymm16 ,ymm17 ,ymm18)
                   "62A67520A8C2     VFMADD213PH YMM16, YMM17, YMM18")
    (test-assemble `(vfmadd231ph ,ymm16 ,ymm17 ,ymm18)
                   "62A67520B8C2     VFMADD231PH YMM16, YMM17, YMM18")

    ;; 3. AVX10.2 Min/Max Operations (VMINMAXPS, VMINMAXPD, VMINMAXPH, VMINMAXBF16)
    (test-assemble `(vminmaxps ,ymm0 ,ymm1 ,ymm2 0)
                   "62F3752852C200   VMINMAXPS YMM0, YMM1, YMM2, 0")
    (test-assemble `(vminmaxps-masked ,ymm0 ,ymm1 ,ymm2 0 ,k1 :z)
                   "62F375A952C200   VMINMAXPS YMM0, YMM1, YMM2, 0 {K1} {z}")
    (test-assemble `(vminmaxpd ,ymm0 ,ymm1 ,ymm2 0)
                   "62F3F52852C200   VMINMAXPD YMM0, YMM1, YMM2, 0")
    (test-assemble `(vminmaxph ,ymm0 ,ymm1 ,ymm2 0)
                   "62F3742852C200   VMINMAXPH YMM0, YMM1, YMM2, 0")
    (test-assemble `(vminmaxbf16 ,ymm0 ,ymm1 ,ymm2 0)
                   "62F3772852C200   VMINMAXBF16 YMM0, YMM1, YMM2, 0")
    ;; 512-bit & Extended registers
    (test-assemble `(vminmaxps ,zmm0 ,zmm1 ,zmm2 0)
                   "62F3754852C200   VMINMAXPS ZMM0, ZMM1, ZMM2, 0")
    (test-assemble `(vminmaxps-masked ,zmm0 ,zmm1 ,zmm2 0 ,k2 :z)
                   "62F375CA52C200   VMINMAXPS ZMM0, ZMM1, ZMM2, 0 {K2} {z}")
    (test-assemble `(vminmaxps ,zmm16 ,zmm17 ,zmm18 0)
                   "62A3754052C200   VMINMAXPS ZMM16, ZMM17, ZMM18, 0")

    ;; 4. AVX10.2 Scalar Min/Max (VMINMAXSS, VMINMAXSD, VMINMAXSH)
    (test-assemble `(vminmaxss ,xmm0 ,xmm1 ,xmm2 0)
                   "62F3750853C200   VMINMAXSS XMM0, XMM1, XMM2, 0")
    (test-assemble `(vminmaxsd ,xmm0 ,xmm1 ,xmm2 0)
                   "62F3F50853C200   VMINMAXSD XMM0, XMM1, XMM2, 0")
    (test-assemble `(vminmaxsh ,xmm0 ,xmm1 ,xmm2 0)
                   "62F3740853C200   VMINMAXSH XMM0, XMM1, XMM2, 0")

    ;; 5. Upper Vector Registers Boundary (YMM31, XMM31)
    (try `(vaddph ,ymm31 ,ymm16 ,ymm17))
    (try `(vminmaxps ,ymm31 ,ymm16 ,ymm17 0))
    (try `(vminmaxpd ,ymm31 ,ymm16 ,ymm17 0))
    (try `(vminmaxph ,ymm31 ,ymm16 ,ymm17 0))
    (try `(vaddps ,xmm31 ,xmm16 ,xmm17))
    (try `(vminmaxss ,xmm31 ,xmm16 ,xmm17 0))))

(test-util:with-test (:name :x86-64-dword-symmetric-move-elimination :skipped-on (not :x86-64))
  (let* ((stream (sb-assem:make-asmstream))
    ...
    (let ((res nil))
      (do ((s (sb-assem::section-start section) (sb-assem::stmt-next s)))
          ((null s) (setf res (nreverse res)))
        (push (list (sb-assem::stmt-op s) (sb-assem::stmt-prefix s)) res))
      ;; Expect: IGNORE, MOV (:dword prefix 6), RET (2nd move eliminated)
      (assert (= (length res) 3))
      (assert (eq (caar res) :ignore))
      (assert (eq (caadr res) 'sb-x86-64-asm::mov))
      (assert (eq (cadadr res) 6))
      (assert (eq (caaddr res) 'sb-x86-64-asm::ret)))))
